...
- :code:`MINIMUM` (optional):
    - the minimum value with the `ISO-8601 format <https://en.wikipedia.org/wiki/ISO_8601>`_. If not specified, the behavior is left to the specification of `randdate <randog.factory.html#randog.factory.randdate>`_.

- :code:`MAXIMUM` (optional):
    - the maximum value with the `ISO-8601 format <https://en.wikipedia.org/wiki/ISO_8601>`_. If not specified, the behavior is left to the specification of `randdate <randog.factory.html#randog.factory.randdate>`_.
