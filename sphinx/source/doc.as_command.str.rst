...
.. code-block:: shell
    ...
    python -m randog str [--length LENGTH] [--charset CHARSET] [--fmt FORMAT] [common-options]

    python -m randog str [--regex REGEX] [--fmt FORMAT] [common-options]
...
.. code-block:: shell
    ...
    python -m randog str --length 16

    # generate a string of length 8 - 16, which uses chars "0123456789abcdef"
    python -m randog str --length 8:16 --charset 0123456789abcdef
...
.. code-block:: shell
    ...
    python -m randog str --regex '[a-zA-Z0-9]{10,20}'
...
.. code-block:: shell
    ...
    python -m randog str --length 4 --fmt '>10'
