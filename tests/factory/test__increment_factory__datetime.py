...
def test__increment__datetime(initial_value, expected):
...
def test__increment__datetime__or_none():
...
def test__increment__datetime__or_none_0():
    initial_value = dt.datetime(2000, 1, 2, 3, 4, 58)
...
def test__increment__datetime__maximum(maximum, expected, resume, caplog):
...
def test__increment__datetime__step(step, expected, caplog):
    caplog.set_level(logging.DEBUG)
    initial_value = dt.datetime(2000, 1, 2, 3, 4, 58)
...
def test__increment__datetime__error_when_maximum_is_lower_than_initial_value(
    initial_value, maximum
):
